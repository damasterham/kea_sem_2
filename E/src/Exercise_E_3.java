...
public class Exercise_E_3
{
    ...
    public static void main(String[] args)
    {
        ...
        tree1 = new Exercise_E_3(6);
        tree2 = new Exercise_E_3(9);
        tree3 = new Exercise_E_3(8);

        System.out.println("Sideways: down is left");
        tree1.printSideways();
        System.out.println("------------------------------------------");
        tree2.printSideways();
        System.out.println("------------------------------------------");
        ...
        System.out.println("tree1 has " + tree1.countLeft() + " left nodes");
        System.out.println("tree2 has " + tree2.countLeft() + " left nodes");
        System.out.println("tree3 has " + tree3.countLeft() + " left nodes");
