...
public class Exercise_E_4
{
    ...
    public static void main(String[] args)
    {
        ...
        tree1 = new Exercise_E_4(6);
        tree2 = new Exercise_E_4(9);
        tree3 = new Exercise_E_4(8);
        ...
        System.out.println("tree1 has " + tree1.countEmpty() + " empty branches");
        System.out.println("tree2 has " + tree2.countEmpty() + " empty branches");
        System.out.println("tree3 has " + tree3.countEmpty() + " empty branches");
